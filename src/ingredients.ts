...
export const chineseAubergine = ingr('chinese aubergine');
export const potato = ingr('potato');
export const broccoli = ingr('broccoli');
export const asparagus = ingr('asparagus');
...
export const corn = ingr('corn');
export const avocado = ingr('avocado');
...
export const greenOlives = ingr('green olives');
...
export const chiliFlakes = ingr('chili flakes');
